...
<Card>
    <div id="container" class="bg-green-500">
        <div id="max" style="{maxHeight}" class="bg-red-500"></div>
        <div id="min" style="{minHeight}" class="bg-red-500"></div>
        <div id="label" style="{position}" class="bg-white text-black dark:bg-black dark:text-white">{value.toFixed(2)} {bounds.units}</div>
    </div>
