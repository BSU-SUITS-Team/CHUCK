...
namespace ARSIS.UI
{
    ...
    public class HololensCommandManager : MonoBehaviour, IRenderable
    {
        ...
        private static HololensCommandManager activeHandler;
        private static HololensCommandManager windowOwner;
        ...
        public static GameObject OpenWindow(string windowName)
        {
            ...
            {
                Debug.LogWarning($"HololensCommandManager: Unknown hololens window '{windowName}'.");
                return null;
            }
            ...
            if (prefab == null)
            {
                Debug.LogWarning($"HololensCommandManager: Could not load window prefab at Resources/{prefabPath}.");
                return null;
            }
        ...
        public static void CloseWindow(string windowName)
        {
            ...
            Debug.LogWarning($"HololensCommandManager: No open hololens window found for '{windowName}'.");
        }

        public static GameObject OpenPrefab(GameObject prefab)
        {
            return OpenPrefab(prefab, NormalizeWindowName(prefab != null ? prefab.name : null));
        }
        ...
        void OnEnable()
        {
            ...
            {
                Debug.LogWarning("HololensCommandManager: Another active command manager is already registered.");
                return;
            }
        ...
        private static GameObject OpenPrefab(GameObject prefab, string windowId)
        {
            if (prefab == null)
            {
                Debug.Log("HololensCommandManager: Failed to load prefab.");
                return null;
            }
        ...
        private static GameObject FindFloatingWindowInstance(GameObject prefab, string windowId)
        {
            ...
            FloatingMenuFromPrefab[] floatingMenus = UnityEngine.Object.FindObjectsOfType<FloatingMenuFromPrefab>(true);
        ...
        private static void DestroyWindowInstance(GameObject instance)
        {
        ...
        private static void RegisterWindowInstance(string windowId, GameObject prefab, GameObject instance)
        {
            if (instance == null)
                return;
        ...
        private static void RegisterOwnedInstance(string key, GameObject instance)
        {
        ...
        private static void DestroyAllWindowInstances()
        {
        ...
        private void HandleHololensCommand(HololensCommand command)
        {
            ...
            switch (data.action)
            {
                ...
                case "open_procedure":
                    ...
                    break;
                default:
                    Debug.LogWarning($"HololensCommandManager: Unsupported hololens command action '{data.action}'.");
                    break;
            }
        }
        ...
        private static void OpenProcedure(string procedureName)
        {
            Procedure procedure = FindProcedureByName(procedureName);
            if (procedure == null)
            {
                Debug.LogWarning($"HololensCommandManager: No procedure found named '{procedureName}'.");
                return;
            }
            ...
            {
                Debug.LogWarning($"HololensCommandManager: Could not load procedure display prefab at Resources/{ProcedureDisplayPrefabPath}.");
                return;
            }

            GameObject display = UnityEngine.Object.Instantiate(procedureDisplayPrefab);
            ProcedureDisplay view = display.GetComponent<ProcedureDisplay>();
            if (view == null)
            {
                Debug.LogWarning("HololensCommandManager: Procedure display prefab has no ProcedureDisplay component.");
        ...
        private static Procedure FindProcedureByName(string procedureName)
        {
